...
//		shell.dispose();
	...
	public void create(String operation, String str){
		 ...
		 * data.grabExcessHorizontalSpace = true; data.horizontalSpan = 3;
		 * data.verticalSpan = 4; data.heightHint = 50;
		 */
		// 新增交易标题
...
//	}
	 ...
	 * 
	 * try { StockSituation window = new StockSituation(this);
	 * window.open("修改交易"); } catch (Exception e) { e.printStackTrace(); } }
	 */
