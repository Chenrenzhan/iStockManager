...
public class DlgStockHistory extends Dialog {
	...
	public DlgStockHistory(Shell parent) {
...
//		shell.dispose();
	...
	public void create() {
		...
		dateLabel.setForeground(SWTResourceManager
		...
		typeLabel.setForeground(SWTResourceManager
				.getColor(SWT.COLOR_LIST_SELECTION));
		...
		priceLabel.setForeground(SWTResourceManager
				.getColor(SWT.COLOR_LIST_SELECTION));
		...
		countLabel.setForeground(SWTResourceManager
				.getColor(SWT.COLOR_LIST_SELECTION));
		countLabel.setText("\u6570\u91CF");
		new Label(shell, SWT.NONE);

		Label remarkLabel = new Label(shell, SWT.NONE);
		remarkLabel.setForeground(SWTResourceManager
				.getColor(SWT.COLOR_LIST_SELECTION));
		...
		optionLabel.setForeground(SWTResourceManager
				.getColor(SWT.COLOR_LIST_SELECTION));
		...
		setBtn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				try {
					DlgStockSituation stockDetails = new DlgStockSituation(
							shell);
